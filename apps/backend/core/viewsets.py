...
class BaseScopedModelViewSet(ScopeQuerySetMixin, ModelViewSet): 
    ...
    def perform_create(self, serializer): 
        ...
        serializer.save( owner_type = scope.owner_type, owner_id = scope.owner_id, created_by = self.request.user ) 
...
class OwnedModelListView( OwnedScopeQuerysetMixin, ScopeQuerySetMixin, ListModelMixin, GenericViewSet ): 
