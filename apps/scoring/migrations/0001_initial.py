    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ball_number', models.PositiveIntegerField(help_text='Sequential ball count within the innings')),
                ('over_number', models.DecimalField(decimal_places=1, help_text='Cricket over notation (e.g. 12.3)', max_digits=4)),
                ('striker_runs', models.PositiveSmallIntegerField(default=0)),
                ('bowler_runs', models.PositiveSmallIntegerField(default=0)),
                ...
                ('no_ball_type', models.CharField(blank=True, help_text='overstep / height / free_hit etc.', max_length=20, null=True)),
                ('edit_later', models.BooleanField(default=False, help_text='Marked for post-match review')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_ball', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='scoring.ball')),
            ],
        ),
        migrations.AddIndex(
            model_name='ball',
